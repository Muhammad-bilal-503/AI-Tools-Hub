...
export default function CodeDocsTool() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await api.post('/ai/code-docs', form);
  ...
  return (
    <ToolPage icon="📝" title="AI Code Documentation Generator" desc="Code paste karo — README + docs auto banao">
